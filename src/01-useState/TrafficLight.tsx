...
export const TrafficLight = () => {
  ...
  const hadleColorChange = (color: TrafficLightColor) => {
    setLight((prevState) => {
      console.log(prevState); // Vemos el valor anterior
      return color;
    });
  };
      ...
      <div className="flex flex-col items-center space-y-8">
        ...
        <div className="flex gap-2">
          <button
            ...
            onClick={() => hadleColorChange("red")}
          >
            Rojo
          </button>
          <button
            className="bg-yellow-500 text-white px-4 py-2 rounded-md cursor-pointer"
            onClick={() => hadleColorChange("yellow")}
          >
            Amarillo
          </button>
          <button
            className="bg-green-500 text-white px-4 py-2 rounded-md cursor-pointer"
            onClick={() => hadleColorChange("green")}
          >
            Verde
          </button>
        </div>
